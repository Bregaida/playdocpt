h1. O modelo de objeto de domínio
...
h2. <a name="properties">Simulação de propriedades</a>
...
h2. <a name="hibernate">Persistindo o seu objeto de modelo com Hibernate</a>
...
Now we’ll check how to persist the model using %(next)"Persistência em JPA":jpa%.
