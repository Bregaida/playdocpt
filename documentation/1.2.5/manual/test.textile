...
h2. <a name="writing">Escrevendo testes</a>
...
h2. <a name="running">Rodando os testes</a>
...
h2. <a name="continuous">Integração contínua, and running the tests automatically</a>
...
Próximo: %(next)"Security guide":security%.
