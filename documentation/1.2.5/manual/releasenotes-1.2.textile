...
h2. Gerenciamento de dependências
...
The Play documentation now includes several Resumos that provide a quick reference for the common Play functions. They can be easily printed.
