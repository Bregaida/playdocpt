h1. Programação assíncrona com HTTP
...
h2. Suspendendo requisições HTTP
...
h2. Transmissão de resposta HTTP
...
Next, doing %(next)"Requisições Ajax":ajax%.