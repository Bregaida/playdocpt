...
* "F":/@api/play/libs/F.html: Programação funcional com java.
* "Files":/@api/play/libs/Files.html: File system manipulation helpers.
* "I18N":/@api/play/libs/I18N.html: Internationalização helpers.
...
* "WS":/@api/play/libs/WS.html: Powerful Cliente Web Service.
...
h2. Programação funcional com java
