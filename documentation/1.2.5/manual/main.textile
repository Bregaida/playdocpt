...
h2. <a name="mvc">O modelo de aplicação MVC</a>
...
Now that you’ve seen what a Play application is, let’s see how %(next)"roteamento HTTP":routes% works. The Router is in charge of translating incoming HTTP Requests into actions.
