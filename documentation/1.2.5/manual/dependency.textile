h1. Gerenciamento de dependências
...
h2. <a name="format">Formato de dependências</a>
...
h2. <a name="conflicts">Resolução de conflitos</a>
...
h2. <a name="repositories">Adicionando novos repositórios</a>
...
Próximo: %(next)"Database evolutions":evolutions%.
