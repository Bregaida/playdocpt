...
h2. <a name="what">O que é um módulo?</a>
...
h2. <a name="loading">Como carregar um módulo de uma aplicação</a>
...
h2. <a name="routes">Carregando rotas padrão de módulos</a>
...
h2. <a name="repository">Usando o repositório de módulos</a>
...
h2. <a name="contributing">Contribuindo com um novo módulo para o repositório</a>
...
Aprenda how to efficiently manage your modules using %(next)"Gerenciamento de dependências":dependency%.
