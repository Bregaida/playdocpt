...
There are two steps to perform: "internationalisation":http://en.wikipedia.org/wiki/Internationalização_and_localization and "localisation":http://en.wikipedia.org/wiki/Language_localisation. Both are mostly about text. 
...
p(note). Próximo: Now you have finished the tutorial, move on to The Essential Documentation - %(next)"Conceitos principais":main%. 
