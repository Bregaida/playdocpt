...
**gae:deploy** コマンドを使って、アプリケーションを Google のクラウドにデプロイすることができます。 **--gae** オプションを使って GAE sdk の場所を指定する必要があります:

bc. # play gae:deploy --gae=/Users/guillaume/Desktop/appengine-sdk-1.4.0
...
代わりの永続化マネージャとして "Siena":http://www.playframework.org/modules/siena と呼ばれるモジュールを提供しています。こちらのほうがより良く適合し、JPA を使う場合よりコードもシンプルになります。
